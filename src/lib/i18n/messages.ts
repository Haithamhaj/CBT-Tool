...
const messages = {
  en: {
    ...
    navSessionRoadmap: "5-Session Roadmap",
    navDisorders: "Disorders Library",
    ...
    loginEmailOnlySubtitle: "Sign in using your email only.",
    signupEmailOnlySubtitle: "Create a trainee account using your name and email only.",
    loginSharedPasswordSubtitle: "Sign in using your email and the shared platform password.",
    signupSharedPasswordSubtitle: "Create a trainee account using your name, email, and the shared platform password.",
    ...
    emailOnlyAuthNote: "This version uses email-only access. The email identifies the user record and usage history.",
    sharedPasswordAuthNote: "This version uses one shared platform password. The email identifies the user record and usage history.",
    ...
    errorInvalidAccessPassword: "The shared platform password is incorrect.",
    errorAccountAlreadyExists: "An account already exists for that email.",
    ...
    lectureActionPdf: "Download PDF",
    lecturePdfReadyTitle: "Print dialog ready",
    lecturePdfReadyHint: "Use your browser destination settings to save this lecture as a PDF file.",
  ...
  ar: {
    ...
    navSessionRoadmap: "لوحة الجلسات الخمس",
    navDisorders: "مكتبة الاضطرابات",
    ...
    loginEmailOnlySubtitle: "ادخل باستخدام بريدك الإلكتروني فقط.",
    signupEmailOnlySubtitle: "أنشئ حساب متدرب باستخدام الاسم والبريد الإلكتروني فقط.",
    loginSharedPasswordSubtitle: "ادخل باستخدام بريدك الإلكتروني وكلمة المرور الموحدة للمنصة.",
    signupSharedPasswordSubtitle: "أنشئ حساب متدرب باستخدام الاسم والبريد الإلكتروني وكلمة المرور الموحدة للمنصة.",
    ...
    emailOnlyAuthNote: "هذه النسخة تستخدم الدخول بالبريد الإلكتروني فقط. البريد يحدد هوية المستخدم وسجل استخدامه.",
    sharedPasswordAuthNote: "هذه النسخة تستخدم كلمة مرور موحدة للمنصة. البريد الإلكتروني يحدد هوية المستخدم وسجل استخدامه.",
    ...
    errorInvalidAccessPassword: "كلمة المرور الموحدة للمنصة غير صحيحة.",
    errorAccountAlreadyExists: "يوجد حساب مسجل بالفعل لهذا البريد الإلكتروني.",
    ...
    lectureActionPdf: "تنزيل PDF",
    lecturePdfReadyTitle: "المحاضرة جاهزة للحفظ",
    lecturePdfReadyHint: "من نافذة الطباعة اختر الحفظ بصيغة PDF لتنزيل المحاضرة كملف PDF.",
...
const exactServerTextKeys: Record<string, keyof typeof messages.en> = {
  ...
  "Invalid access password.": "errorInvalidAccessPassword",
  "An account already exists for that email.": "errorAccountAlreadyExists",
