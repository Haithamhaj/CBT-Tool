...
const messages = {
  en: {
    appTitle: "CBT MVP",
    appSubtitle: "Runtime-backed shell",
    ...
    loginTitle: "Log In",
    loginSubtitle: "Use your real database user record to enter the training shell.",
    loginMagicLinkSubtitle: "Enter your email and we will send a Magic Link to open the training shell.",
    ...
    referenceHubSubtitle: "A practical study map of the trainer material for quick review, learning support, and grounding during practice.",
  ...
  ar: {
    appTitle: "تدريب العلاج المعرفي السلوكي",
    appSubtitle: "نسخة تشغيلية مرتبطة بقاعدة البيانات",
    ...
    loginSubtitle: "استخدم سجل المستخدم الحقيقي من قاعدة البيانات للدخول إلى بيئة التدريب.",
    loginMagicLinkSubtitle: "أدخل بريدك الإلكتروني وسنرسل لك رابط دخول مباشر لفتح بيئة التدريب.",
    ...
    referenceHubSubtitle: "خريطة عملية لمادة المدرب للمراجعة السريعة والتعلّم والرجوع إليها وقت الالتباس أثناء التدريب.",
