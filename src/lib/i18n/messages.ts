...
const messages = {
  en: {
    ...
    loginPasswordSubtitle: "Sign in directly with your email and password.",
    signupPasswordSubtitle: "Create a trainee account with email and password. Email confirmation should stay disabled for this experimental setup.",
    ...
    passwordAuthNote: "This version uses direct email and password login for trainees. No login email should be needed.",
    signupNeedsEmailConfig: "Account created, but automatic sign-in did not complete. Disable email confirmation in Supabase Auth settings for password-only access.",
    ...
    previewAccessMode: "Preview access mode",
    previewAccessHint: "Preview deployments also allow a direct app-profile login by email only. Use this when Supabase password login blocks UI review.",
    previewAccessButton: "Enter preview access",
    ...
    lecturesSubtitle: "Full educational lecture pages with optional recap, concept, warning, and visual support blocks.",
    lecturesLayerBadge: "Lecture Layer",
    lecturesIntro:
      "This layer keeps the lecture itself as the primary truth, then adds selective learning support where the material benefits from recap cards, distinctions, criteria, staged breakdowns, or guided reflection.",
    lectureNumberLabel: "Lecture",
    lectureLabelRealTopic: "Real Topic",
    lectureLabelCentralMessage: "Central Message",
    lectureLabelWhyImportant: "Why It Matters",
    lectureActionPrint: "Print lecture",
    lectureActionDownload: "Download lecture",
    lectureSectionNavTitle: "Navigate this lecture",
    lectureSectionNavBadge: "In-page",
    lectureSectionFullLesson: "Full lesson",
    lectureSectionSummaryCards: "Summary cards",
    lectureSectionConcepts: "Concepts",
    lectureSectionDistinctions: "Key distinctions",
    lectureSectionFrameworks: "Frameworks and structures",
    lectureSectionSymptomGroups: "Symptom groups",
    lectureSectionCriteria: "Criteria",
    lectureSectionStages: "Stages",
    lectureSectionTools: "Tools",
    lectureSectionWarnings: "Warnings and misunderstandings",
    lectureSectionQA: "Q&A highlights",
    lectureSectionVisuals: "Visual breakdowns",
    lectureSectionQuestions: "Thinking questions",
    lectureSectionExercise: "Reflection exercise",
    lectureSectionRecap: "Living recap",
    lecturePrimaryTextBadge: "Primary text",
    lectureTypeConceptual: "Conceptual",
    lectureTypeDiagnostic: "Diagnostic",
    lectureTypeStructural: "Structural",
    lectureTypePractical: "Practical",
    lectureTypeMixed: "Mixed",
  ...
  ar: {
    ...
    loginPasswordSubtitle: "ادخل مباشرة باستخدام البريد الإلكتروني وكلمة المرور.",
    signupPasswordSubtitle: "أنشئ حساب متدرب باستخدام البريد الإلكتروني وكلمة المرور. يجب أن يبقى تحقق البريد معطلاً في هذا الإعداد التجريبي.",
    ...
    passwordAuthNote: "هذه النسخة تستخدم دخولًا مباشرًا بالبريد وكلمة المرور للمتدربين. لا ينبغي الحاجة إلى بريد دخول.",
    signupNeedsEmailConfig: "تم إنشاء الحساب، لكن لم يكتمل الدخول التلقائي. عطّل تأكيد البريد من إعدادات Supabase Auth إذا كنت تريد دخولًا مباشرًا بدون تحقق.",
    ...
    previewAccessMode: "وضع دخول المعاينة",
    previewAccessHint: "في نسخ المعاينة يمكنك أيضًا الدخول مباشرة عبر ملف المستخدم داخل التطبيق باستخدام البريد فقط، وذلك عندما يمنعك تسجيل دخول Supabase من مراجعة الواجهة.",
    previewAccessButton: "ادخل وضع المعاينة",
    ...
    lecturesSubtitle: "صفحات محاضرات تعليمية كاملة مع طبقات اختيارية للبطاقات والمفاهيم والتحذيرات والدعم البصري.",
    lecturesLayerBadge: "طبقة المحاضرات",
    lecturesIntro:
      "هذه الطبقة تبقي نص المحاضرة نفسه هو الحقيقة الأساسية، ثم تضيف دعمًا تعليميًا انتقائيًا حين تحتاج المادة إلى بطاقات مراجعة، أو تمييزات، أو محكات، أو مراحل، أو أسئلة تفكير.",
    lectureNumberLabel: "المحاضرة",
    lectureLabelRealTopic: "موضوعها الحقيقي",
    lectureLabelCentralMessage: "الرسالة المركزية",
    lectureLabelWhyImportant: "لماذا هي مهمة؟",
    lectureActionPrint: "طباعة المحاضرة",
    lectureActionDownload: "تنزيل المحاضرة",
    lectureSectionNavTitle: "التنقل داخل المحاضرة",
    lectureSectionNavBadge: "داخل الصفحة",
    lectureSectionFullLesson: "المحاضرة الكاملة",
    lectureSectionSummaryCards: "بطاقات الملخص",
    lectureSectionConcepts: "المفاهيم",
    lectureSectionDistinctions: "التمييزات المهمة",
    lectureSectionFrameworks: "الأطر والبنى",
    lectureSectionSymptomGroups: "مجموعات الأعراض",
    lectureSectionCriteria: "المحكات",
    lectureSectionStages: "المراحل",
    lectureSectionTools: "الأدوات",
    lectureSectionWarnings: "التحذيرات وسوء الفهم",
    lectureSectionQA: "أسئلة ونقاشات",
    lectureSectionVisuals: "التفكيكات البصرية",
    lectureSectionQuestions: "أسئلة تفكير",
    lectureSectionExercise: "تمرين انعكاسي",
    lectureSectionRecap: "الخلاصة الحية",
    lecturePrimaryTextBadge: "النص الأساسي",
    lectureTypeConceptual: "مفاهيمية",
    lectureTypeDiagnostic: "تشخيصية",
    lectureTypeStructural: "بنائية",
    lectureTypePractical: "عملية",
    lectureTypeMixed: "مختلطة",
